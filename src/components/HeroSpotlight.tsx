...
export const SPOTLIGHT_SHOWS: SpotlightShowItem[] = [
  ...
  },
  {
    ...
    backdrop_path: 'https://images.unsplash.com/photo-1528164344705-47542687990d?auto=format&fit=crop&w=1600&q=80',
    poster_path: 'https://images.unsplash.com/photo-1528164344705-47542687990d?auto=format&fit=crop&w=800&q=80',
    media_type: 'tv',

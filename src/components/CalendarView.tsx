...
// Sample upcoming episode schedule data for shows in watching/popular lists
const UPCOMING_EPISODES_DATA: UpcomingEpisode[] = [
  {
    id: 101,
    showId: 110492,
    showName: 'Severance',
    posterPath: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&w=800&q=80',
    backdropPath: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1600&q=80',
    seasonNumber: 2,
    episodeNumber: 1,
    episodeName: 'Goodbye, Mrs. Cobel (Sezon Prömiyeri)',
    airDate: '2026-07-24',
    network: 'Apple TV+',
    networkColor: 'bg-black text-slate-100 border-slate-700',
    overview: 'Mark ve Innie ekibi ameliyatın ardındaki karanlık sırrı çözmek için yeni bir plana başlar.',
    voteAverage: 8.9,
    mediaType: 'tv'
  },
  {
    ...
    seasonNumber: 2,
    episodeNumber: 4,
    episodeName: 'Paint the Town Blue',
    airDate: '2026-07-28',
    network: 'Netflix',
    networkColor: 'bg-red-950 text-red-300 border-red-800',
    overview: 'Piltover konseyi üzerindeki baskı artarken Zaun direnişi kilit bir teknolojik güç elde eder.',
    voteAverage: 9.1,
    mediaType: 'tv'
  },
  {
    ...
    seasonNumber: 2,
    episodeNumber: 2,
    episodeName: 'Jackson (Yeni Bölüm)',
    airDate: '2026-08-02',
    network: 'HBO Max',
    networkColor: 'bg-purple-950 text-purple-300 border-purple-800',
    overview: 'Ellie ve Joel Jackson kasabasındaki huzurlu yaşamı korumak için yeni tehlikelerle yüzleşir.',
    voteAverage: 8.8,
    mediaType: 'tv'
  },
  {
    ...
    seasonNumber: 3,
    episodeNumber: 1,
    episodeName: 'The Battle of the Gullet (Sezon Prömiyeri)',
    airDate: '2026-08-10',
    network: 'HBO Max',
    networkColor: 'bg-purple-950 text-purple-300 border-purple-800',
    overview: 'Ejderhaların savaşı denizlere taşınıyor. Siyahlar ve Yeşiller krallık tarihinin en büyük deniz muharebesine hazırlanıyor.',
    voteAverage: 8.7,
    mediaType: 'tv'
  },
  {
    ...
    showId: 114472,
    showName: 'The Bear',
    posterPath: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80',
    backdropPath: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=1600&q=80',
    seasonNumber: 3,
    episodeNumber: 8,
    episodeName: 'Fishes II',
    airDate: '2026-08-15',
    network: 'Hulu / Disney+',
    networkColor: 'bg-emerald-950 text-emerald-300 border-emerald-800',
    overview: 'Mutfaktaki gerilim zirveye çıkarken Carmy restoran için kritik bir kararla yüzleşir.',
    voteAverage: 8.6,
    mediaType: 'tv'
  },
  {
    ...
    showId: 126308,
    showName: 'Shōgun',
    posterPath: 'https://images.unsplash.com/photo-1528164344705-47542687990d?auto=format&fit=crop&w=800&q=80',
    backdropPath: 'https://images.unsplash.com/photo-1528164344705-47542687990d?auto=format&fit=crop&w=1600&q=80',
    seasonNumber: 2,
    episodeNumber: 1,
    episodeName: 'Anjin (Özel Prömiyer)',
    airDate: '2026-08-22',
    network: 'FX / Hulu',
    networkColor: 'bg-amber-950 text-amber-300 border-amber-800',
    overview: 'Lord Toranaga feodal Japonya\'nın kaderini belirleyecek yeni bir ittifak kurar.',
    voteAverage: 9.0,
    mediaType: 'tv'
  }
];
